...
function DisplayCard({
  className,
  icon = <IconSparkles className="size-4 text-blue-300" />,
  title = "Featured",
  ...
  return (
    ...
    >
      <div>
        <span className="relative inline-block rounded-lg bg-gradient-to-br from-indigo-500/10 to-rose-500/10 border border-white/20 p-1">
          {icon}
        </span>
